...
export function VendorRequestForm() {
  ...
  const [existingRequests, setExistingRequests] = useState<VendorRequest[]>([]);

  const formik = useFormik<VendorRequestFormValues>({
    initialValues: {
      company_name: '',
  ...
  const getFieldError = (field: keyof VendorRequestFormValues) => {
